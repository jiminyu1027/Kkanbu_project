	...
	<div class="container psts">
		<div class="row">
			...
			<div
				...
				<a href="<%=request.getContextPath()%>"><img class="banner-D"
					src="<%=request.getContextPath()%>/resources/image/mainLogo/mainlogo.png" alt="슈롤로그 로고" width="85%"></a>
		...
		<div class="myPageMenu">
			...
			<div class="myPageMenu2">
				...
				<div class="myPageMenu3">
					...
					<a href="<%=request.getContextPath()%>/mypage/claim/insertCard.do" class="red">카드 등록 관리*</a>
				</div><br>
			</div>
			<div class="myPageMenu2">
			...
			<footer class="py-4">
				<div class="row">
					<div class="col-12 col-sm-12 col-md-4">
						<img class="banner-D" src="<%=request.getContextPath()%>/resources/image/mainLogo/mainlogo.png"
					...
					<div class="col-4 col-sm-4 col-md-2">
						...
						<ul class="nav flex-column">
							<li class="nav-item mb-2"><a href="<%=request.getContextPath()%>/customerService/cs.do"
