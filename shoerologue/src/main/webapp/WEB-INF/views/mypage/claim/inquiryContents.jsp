...
<!-- body  -->
	...
	<div class="body-box">
		...
		<!-- 좌측 마이페이지 메뉴 여기서 끝 -->
		<form action="<%=request.getContextPath()%>/mypage/memberCounsel/inquiry.do" method="post">	
		<input type="hidden" name="qidx" value="<%=ivo.getQidx() %>">	
			<table>
				...
				<input type="button" value="목록보기" onclick="location.href='<%=request.getContextPath()%>/mypage/memberCounsel/inquiry.do'" class="btnFn" style="background-color:white;">
		</form>	
	<div class="empty-box"></div>
	<div class="empty-box"></div>	
	...
	<div>
		<form action="<%=request.getContextPath()%>/mypage/claim/comment.do" method="post" class="commentBox">
			<p>
			...
			<p>
				...
				작성자 : <input type="text" name="mName" value="${member.mName}" readonly>
