	...
	<div class="myPageMainBox">
		...
		<div class="myPageMenu">
			...
			<div class="myPageMenu2">
				...
				<div class="myPageMenu3">
					<a href="<%=request.getContextPath()%>/mypage/deliveryAddr/receiveAddr.do" class="red">배송지 관리*</a><br>
		  ...
		  <div class="modal-dialog">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		        ...
		        <form name="frm" id="frm" method="post" action="<%=request.getContextPath()%>/mypage/deliveryAddr/receiveAddr.do" >
		  ...
		  <div class="modal-dialog">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		        ...
		        <form name="frm2" id="frm2" method="post" action="<%=request.getContextPath()%>/mypage/deliveryAddr/receiveAddrUpdate.do" >
				...
				<script>
				    ...
				    function fn(adidx){
				    	...
				    	$.ajax({
				    		url:"<%=request.getContextPath()%>/mypage/deliveryAddr/addrSelectOne.do",
				    		type:"POST",
				    		data:"adidx="+adidx,
	...
	<script>
	    ...
	    function addrDelBtn(adidx) {
	        if (!confirm("해당 배송지를 삭제하시겠습니까?")) {
		    	...
		    	$.ajax({
		    		url:"<%=request.getContextPath()%>/mypage/deliveryAddr/delete.do",
		    		type:"POST",
		    		data:"adidx="+adidx,
		    		success:function(data){
		    			alert("배송지가 삭제되었습니다.");
