		...
		<div class="myPageMenu">
			...
			<div class="myPageMenu2">
				...
				<div class="myPageMenu3">
					...
					<a href="<%=request.getContextPath()%>/mypage/shopping/qaList.do" class="red">QNA 목록*</a><br>
					...
					%>
							<tr class="inquiry-contents-box">
								...
								<td class="inquiry-subject-detail">
									<a href="<%=request.getContextPath()%>/customerService/qaDetail.do?pqidx=<%=pqlist.get(i).getPqidx()%>"><%=pqlist.get(i).getPqSubject() %></a>
								</td>
					...
					<%
 					...
 					%>
							<tr class="inquiry-contents-box">
								...
								<td class="inquiry-subject-detail">
									<a href="<%=request.getContextPath()%>/customerService/qaDetail.do?pqidx=<%=masterList.get(j).getPqidx()%>"><%=masterList.get(j).getPqSubject() %></a>
								</td>
