...
<!-- body  -->
	...
	<c:if test="${master eq 'master'}">
		...
		<div class="myPageMenu">
			...
			<div class="myPageMenu2">
				...
				<div class="myPageMenu3">
					...
					<a href="<%=request.getContextPath()%>/mypage/shopping/myReview.do" class="red">리뷰 목록*</a>
				</div>
			</div>
			<div class="myPageMenu2">
		...
		<br>
		<br>	
		<form action="<%=request.getContextPath()%>/mypage/shopping/reviewDel.do" method="post">
