	...
	<section>
			...
			<div class="logbox">
				...
				<div class="rows id  mt-4">
					...
					<input type="text" class="id impor" name="mId" id="id" placeholder=" USER ID" onblur="checkFn('id')">
					<div class="확인"></div>
				</div>
				...
				<div class="rows password mt-3">
					...
					<input type="password" class="impor" name="mPwd" id="password" placeholder=" USER PASSWORD" onblur="checkFn('pass')">
					<span class="확인"></span>
				</div>
				<div class="rows mt-4">
					<label>
				...
				<div class="mt-3">
					<a href="<%=request.getContextPath()%>/member/findId.do">아이디 찾기 </a> | <a href="<%=request.getContextPath()%>/member/findPwd.do">비밀번호 찾기</a> 
				</div>
				<!--  
				<c:if test="${msg == false}">
