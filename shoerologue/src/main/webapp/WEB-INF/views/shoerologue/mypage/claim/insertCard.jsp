...
<body>
	<div class="container">
		<nav class="navbar navbar-expand-lg navbar-light topNav">
			...
			<ul class="nav justify-content-end">
				...
				<li class="nav-item"><a
					class="nav-link text-black-50 fw-bolder"
					href="/Shoerologue/join.do">회원가입</a></li>
			</ul>
		</nav>
	</div>
	...
	<div class="container psts">
		<div class="row">
			<!-- 로고 -->
			<div
				class="col-5 col-sm-5 col-md-4 col-lg-3 text-center d-flex px-1 logo-scroll mt-4">
				<a href="/main.do"><img class="banner-D"
					src="resources/image/mainLogo/mainlogo.png" alt="슈롤로그 로고" width="85%"></a>
				<div class="logo-scroll3"></div>
			</div>
			<!-- 검색창 -->
			<div class="col-7 col-sm-7 col-md-6 col-lg-6 search">
				<form class="d-flex">
					<input class="form-control me-2 searchStyle" type="search"
						placeholder="검색어를 입력해주세요" aria-label="검색창">
			...
			<!-- 마이페이지 찜목록 장바구니 -->
			<div
				class="col-0 col-sm-0 col-md-2 col-lg-3 d-flex justify-content-center align-items-center">
				<ul class="iconul d-flex align-items-center icon-absolute">
					<li class="iconli"><a href="#"> <i
							class="bi bi-person icon"></i>
					</a></li>
					<li class="iconli"><a href="#"> <i
							class="bi bi-heart icon"></i>
					</a></li>
					<li class="iconli"><a href="#"> <i class="bi bi-bag icon"></i>
					</a></li>
				</ul>
			</div>
		</div>
	...
	<div class="row menu">
		<nav class="navbar navbar-expand-lg navbar-light">
			<div
				class="col-0 col-sm-0 col-md-0 col-lg-2 d-sm-none d-md-block d-none"></div>
			<div class="col-10 col-sm-8 col-md-6 col-lg-5">
				<ul class="nav navMenu">
					<li class="nav-item"><a
						class="nav-link fw-bolder text-white nav-fs" href="#">BRAND</a></li>
	...
	<div class="myPageMainBox">
		...
		<div class="myPageMenu">
			...
			<div class="myPageMenu2">
				...
				<div class="myPageMenu3">
					...
					<a href="insertCard.do" class="red">카드 등록 관리*</a>
				</div><br>
			</div>
			<div class="myPageMenu2">
		...
		<div class="myPageListBox">
			<div style="float: left; width: 100%;" class="myPageLine"><h2>결제 카드 등록</h2></div><br><br><br>
				* 등록하신 카드 정보로 자동결제가 이루어 집니다.<br> * 개인/법인명의의 신용카드 및 체크카드만 등록이
				가능합니다.<br>
				<br>

				<!-- 버튼 트리거 모달 -->
				<button type="button" class="btn btn-dark cashCard"
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title" id="staticBackdropLabel">ShoeRologue
									결제 카드 등록</h5>
									...
									<div class="nos-card">
										<div class="nos-card1">
											<form action="/ShoeRologue/card/cardadd.do" method="post"
												...
												<ul class="card_one">
													<li>ShoeRologue 이니시스</li>
													<li>안전하고 편리한 결제입니다.</li>
												</ul>
												<hr>
												<ul class="nos-card2 card_btn2 ludnd">
													<li><h5>카드번호</h5></li>
													<li><input type="text" name="cardnum1" class="cardcss"
														onKeyDown="if(event.keyCode == 13) loginChk()"
														maxlength="4"> <input type="text" name="cardnum2"
														class="cardcss"
														onKeyDown="if(event.keyCode == 13) loginChk()"
														maxlength="4"> <input type="text" name="cardnum3"
														class="cardcss"
														onKeyDown="if(event.keyCode == 13) loginChk()"
														maxlength="4"> <input type="text" name="cardnum4"
														class="cardcss"
														onKeyDown="if(event.keyCode == 13) loginChk()"
														maxlength="4"></li>
												</ul>
												<ul class="cardcss2 card_btn2 ludnd">
													<li><h5>유효기간</h5></li>
													<li class="cardcss3"><select name="carddate"
														style="float: left;"
														onKeyDown="if(event.keyCode == 13) loginChk()">
															<option>01월</option>
															<option>02월</option>
												...
												<ul class="nos-card2 card_btn2 ludnd">
													<li><h5>카드구분</h5></li>
													<li><input type="radio" name="cardwin" value="man"
														onclick="doOpenCheck(this);"
														onKeyDown="if(event.keyCode == 13) loginChk()">개인
														<input type="radio" name="cardwin" value="company"
														onclick="doOpenCheck(this);"
														onKeyDown="if(event.keyCode == 13) loginChk()">법인</li>
												</ul>
												<ul class="nos-card2 ludnd">
													<li><h5>주민등록번호</h5></li>
													<li class="cardcss4"><input type="text" name="mannum"
														class="cardcss"
														onKeyDown="if(event.keyCode == 13) loginChk()"
														maxlength="6"> - <input type="text" name="mannum1"
														class="cardcss"
														onKeyDown="if(event.keyCode == 13) loginChk()"
														maxlength="7"></li>
												</ul>
												<ul class="nos-card2 ludnd dans">
													<li><h5>카드이름</h5></li>
													<input type="text" name="cname" class="cardcss"
														onKeyDown="if(event.keyCode == 13) loginChk()"
														maxlength="10">
												</ul><hr>
												<div>
													<ul class="card_btn1">
														<li>- 주민번호는 정보통신망법 제 23조에 따라 본인확인 용도로만 확인됩니다.<br>
															이후 안전하게 폐기 완료됩니다.
														</li>
														<li>- 결제하고자 하는 내용을 충분히 확인 후 진행 해 주시길 바랍니다.</li>
													</ul>
												</div>
										</div>
									</div>
				...
				<div style="float: left; width: 100%;">
					<div class="gray-box notice-box">
						<span style="font-size: 1.5em; font-weight: bold;"><svg
						...
						<ul class="bullet-text-list">
							<li class="bullet-text">ShoeRologue 온라인 물류센터에서 발송되는 상품은 평일
								4시 이전 결제완료 시 당일 출고됩니다.</li>
							<li class="bullet-text">ShoeRologue 및 On the spot 매장에서 발송되는
								상품은 결제완료 후 2~3일 정도 준비 기간이 소요될 수 있습니다. (주말 및 공휴일 제외)</li>
							<li class="bullet-text">업체 상품은 입점사 자체 배송으로 결제완료 후 1~2일 정도 준비
								기간이 소요될 수 있습니다. (주말 및 공휴일 제외)</li>
							<li class="bullet-text">주문 취소 및 배송지 변경은 [결제완료] 단계까지만 가능합니다.</li>
							<li class="bullet-text">[상품준비중] 단계부터는 취소를 원하실 경우 상품을 받으신 후
								반품접수 해주시기 바랍니다.</li>
							<li class="bullet-text">구매 포인트는 구매확정 후 다음 날 적립됩니다.</li>
							<li class="bullet-text">선물하신 주문의 수락 상태 및 자세한 주문 정보는 마이페이지 >
								쇼핑내역 > 선물함에서 확인해주시기 바랍니다.</li>
						</ul>
						<span style="font-size: 1.5em; font-weight: bold;"><svg
								xmlns="http://www.w3.org/2000/svg" width="16" height="16"
								fill="currentColor" class="bi bi-exclamation-circle"
						...
						<ul class="bullet-text-list">
							...
							<li class="bullet-text">여러 개의 상품을 주문하실 경우 상품별로 준비기간이 다를 수
								있습니다.</li>
						...
						<ul class="bullet-text-list">
							<li class="bullet-text">월요일~금요일은 오후 1시 이전 주문 시 당일 도착, 1시 이후
								주문 시 다음날 도착합니다. (연휴 및 공휴일은 발송 불가)<br>금요일 오후 1시 이후 또는 주말에
								주문하실 경우 차주 월요일에 도착합니다.
							</li>
							<li class="bullet-text">아트배송이 가능한 주문 수량이 마감되는 경우 발송이 지연되거나
								불가할 수 있습니다.</li>
							<li class="bullet-text">당사 사정에 따라 아트배송이 불가능한 날이 있을 수 있으며,
								사전에 공지 드립니다.</li>
							<li class="bullet-text">아트배송은 주문 후 상품 옵션 및 배송지 정보 변경이 불가합니다.</li>
							<li class="bullet-text">상품을 보관하기 어려운 배송지의 경우 자동 반송 처리될 수
								있으며, 반송 시 배송비는 고객 부담입니다.</li>
	...
	<!-- 우측하단 TOP 이동 배너 -->
	<a href="#top"> <svg xmlns="http://www.w3.org/2000/svg" width="16"
			height="16" fill="currentColor"
			class="bi bi-arrow-up-circle-fill top fixed" viewBox="0 0 16 16">
	  <path
	...
	<div class="bg-light">
		<div class="row footLine">
			...
			<div class="col-md-8 marginAuto">통합고객센터 1588-9667 월~금 09:00 ~
				12:00 / 13:00 ~ 20:00 토,일 10:00 ~ 14:00 (공휴일 휴무)</div>
			<div class="col-md-2"></div>
		</div>
		<div class="container">
			<footer class="py-4">
				<div class="row">
					<div class="col-12 col-sm-12 col-md-4">
						<img class="banner-D" src="/resources/image/mainlogo.png"
							alt="슈롤로그 로고" width="45%">
						<div class="d-flex w-100 gap-2">
							<br> ㈜ 슈롤로그 대표: 성기훈 | 주소 : 전라북도 전주시 덕진구 쌍문동 <br> 사업자
							등록번호: 001-0456-000456 <br>통신판매업 신고: 제 2021-서울중구-1456호<br>
					...
					<div class="col-4 col-sm-4 col-md-2">
						...
						<ul class="nav flex-column">
							...
							<li class="nav-item mb-2"><a href="#"
								class="nav-link p-0 text-muted">기프트카드 안내</a></li>
							<li class="nav-item mb-2"><a href="#"
					...
					<div class="col-4 col-sm-4 col-md-2 ">
						...
						<ul class="nav flex-column">
							<li class="nav-item mb-2"><a href="#"
								class="nav-link p-0 text-muted">JIMIN</a></li>
							<li class="nav-item mb-2"><a href="#"
								class="nav-link p-0 text-muted">DAYUN</a></li>
							<li class="nav-item mb-2"><a href="#"
								class="nav-link p-0 text-muted">SANGHOON</a></li>
							<li class="nav-item mb-2"><a href="#"
								class="nav-link p-0 text-muted">JAEWON</a></li>
						</ul>
					</div>
					<div class="col-4 col-sm-4 col-md-2">
						<h5>
						...
						<ul class="nav flex-column">
							<li class="nav-item mb-2"><a href="#"
								class="nav-link p-0 text-muted"><svg
				...
				<div class="justify-content-between pt-4 pb-1 mt-4 mb-1 border-top">
					사업자정보확인 | 개인정보처리방침 | 이용약관 | 멤버십 이용약관 | 위치 정보 서비스 이용약관 | 구매안전서비스
					가입사실확인<br>
					<br>
					<p />
					본 상품의 상품 이미지 저작권은 ㈜깐부코리아에 있으며 내용의 무단복제를 금합니다.<br> COPYRIGHT
					&copy;KKANBU KOREA CO,LTD. ALL RIGHTS RESERVED.
				</div>
			</footer>
		</div>
	</div>
