	...
	<div class="bigBox">
		<div class="channel">
			<ul>
				...
				<li><a href="/Shoerologue/category/gender/kids/kids.do">KIDS</a></li>&nbsp;&nbsp;>&nbsp;&nbsp;
				<li>운동화</li>
			</ul>
		</div>
		<div class="shoesBox">
			...
			<div class="shoesList">
				<ul>
					<li><a href="/Shoerologue/category/gender/kids/kidsSneakers.do" class="redBold2">운동화</a></li>
				 	<li><a href="/Shoerologue/category/gender/kids/kidsSports.do">스포츠</a></li>
				    <li><a href="/Shoerologue/category/gender/kids/kidsDressShoes.do">구두</a></li>
