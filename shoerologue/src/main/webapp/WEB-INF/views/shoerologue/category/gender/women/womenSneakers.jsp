	...
	<div class="bigBox">
		<div class="channel">
			<ul>
				...
				<li><a href="/Shoerologue/category/gender/women/women.do">WOMEN</a></li>&nbsp;&nbsp;>&nbsp;&nbsp;
				<li>운동화</li>
			</ul>
		</div>
		<div class="shoesBox">
			...
			<div class="shoesList">
				<ul>
					<li><a href="/Shoerologue/category/gender/women/womenSneakers.do" class="redBold2">운동화</a></li>
				 	<li><a href="/Shoerologue/category/gender/women/womenSports.do">스포츠</a></li>
				    <li><a href="/Shoerologue/category/gender/women/womenDressShoes.do">구두</a></li>
