...
<!-- body  -->
	...
	<div class="bigBox">
		...
		<div class="shoesBox">
			...
			<div class="shoesList">
				<ul>
					<li><a href="/Shoerologue/category/gender/men/menSneakers.do" class="redBold2">운동화</a></li>
				 	<li><a href="/Shoerologue/category/gender/men/menSports.do">스포츠</a></li>
				    <li><a href="/Shoerologue/category/gender/men/menDressShoes.do">구두</a></li>
				    <li><a href="/Shoerologue/category/gender/men/menSandle.do">샌들</a></li>
				    <li><a href="/Shoerologue/category/gender/men/menCasual.do">캐주얼</a></li>
				    <li><a href="/Shoerologue/category/gender/men/menBoots.do">부츠</a></li>
				</ul>
			</div>
