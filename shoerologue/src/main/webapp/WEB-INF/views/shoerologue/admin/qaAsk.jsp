...
<!-- body  -->
	...
	<div class="body-box">
		...
		<div class="filter-box">
			...
			<center><p><a href="/CustomerService/qa.do" class="main">상품 QA</a></p></center>
		...
		<a href="/CustomerService/qa.do" class="cancel"><input type="button" value="QA취소" class="cancel-button"></a>
	</div>	
<!-- 우측하단 TOP 이동 배너 -->
	<div class="empty-box"></div>
	<div class="empty-box"></div>
