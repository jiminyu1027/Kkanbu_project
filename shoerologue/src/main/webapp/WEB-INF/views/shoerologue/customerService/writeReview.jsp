...
<!-- body  -->
	...
	<div class="body-box">
		...
		<br>
		<br>	
		<form action="/CustomerService/myReview.do" method="post" class="frm" id="frm" name="frm">
			<table class="inquiry-box">
				...
				<tr>
					<td>
						<input type="button" value="취소" class="cancelFn" onclick="location.href='myReview.do'">
					</td>
				</tr>
			</table>
		</form>
