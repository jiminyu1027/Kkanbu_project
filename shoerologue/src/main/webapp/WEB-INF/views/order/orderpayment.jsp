...
<head>
	<meta charset="UTF-8">
		...
		<link rel="stylesheet" href="<%=request.getContextPath() %>/resources/css/orderpayment.css">	
	<style>
...
<div class="sectionBox">
	<form name="frm" action="#" method="POST" autocomplete="off" onsubmit="return false;">
		...
		<div class="infoBox">
					...
					%>
						<tr class="trBorder">
							<td class="imgSize">
									<img src="<%=request.getContextPath() %>/resources/<%=list.get(i).getpFile1()%>" width="120px">
							</td>
	...
	<div class="contentBox-wrap">
		<div class="contentBox">
			...
			function test(midx){
				$.ajax({
		    		url:"<%=request.getContextPath() %>/order/tests.do",
		    		type:"POST",
		    		data:"midx="+midx,
