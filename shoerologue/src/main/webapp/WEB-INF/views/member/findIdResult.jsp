	...
	<c:if test="${ empty vo.getmId()}">
		<section>
			<div class="logbox">
				...
				<div class="rows mt-4 btnPosition">
					<label>
						<input type="button" class="btn btn-secondary findInfobtn" value="아이디 찾기" id="findId" onclick="location.href='/shoerologue/member/findId.do'">
					</label>
				</div>
				</div>
				<br><br><br>
