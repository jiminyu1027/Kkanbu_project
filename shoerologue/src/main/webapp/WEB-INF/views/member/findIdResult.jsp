...
<!-- 아이디 찾기 -->
	<!-- 정보에 일치하는 아이디가 있을때 (아이디찾기 성공) -->
	<c:if test="${ not empty vo.getmId()}">
		<section>
			<div class="logbox">
				...
				<div class="rows Name succBox mt-2">
					<a class="findInfoSize0">회원님의 정보와 일치하는 아이디입니다.</a>
				</div>
				<div class="mt-3">&nbsp;</div>
				<div class="rows mt-2 findInfoEndLine2 mt-5"></div>
				<div class="rows IdListBox1 mt-3" style=" float: left; width: 50%;">
					<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-check-circle mb-1" viewBox="0 0 16 16">
					  <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
					  <path d="M10.97 4.97a.235.235 0 0 0-.02.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-1.071-1.05z"/>
					</svg>
					<a class="findInfoSize"><%=vo.getmId() %></a>
				</div>
				...
				<div class="rows mt-4 btnPosition">
					<label>
						<input type="button" class="btn btn-secondary findInfobtn" value="로그인" id="findId" onclick="location.href='<%=request.getContextPath()%>/login.do'">
					</label>
				</div>
				</div>
				<br><br><br>
	...
	<!-- 정보에 일치하는 아이디가 없을때 (아이디찾기 실패) -->
	<c:if test="${ empty vo.getmId()}">
		<section>
			<div class="logbox">
				<div class="header mt-3">
					아이디 찾기
				...
				<div class="rows Name succBox mt-2">
					<a class="findInfoSize0">회원님의 정보와 일치하는 아이디가 없습니다.</a>
				</div>
				<div class="mt-3">&nbsp;</div>
				<div class="rows mt-2 findInfoEndLine2 mt-5"></div>
				<div class="rows IdListBox1 mt-3" style=" float: left; width: 70%;">
					...
					<a class="findInfoSize">아이디가 존재하지 않습니다.</a>
				</div>
				...
				<div class="rows mt-4 btnPosition">
					<label>
						<input type="button" class="btn btn-secondary findInfobtn" value="아이디 찾기" id="findId" onclick="location.href='<%=request.getContextPath()%>/member/findId.do'">
					</label>
				</div>
				</div>
				<br><br><br>
