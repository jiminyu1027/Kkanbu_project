...
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1, minimum-scale=1">
		...
		<link rel="stylesheet" href="<%=request.getContextPath() %>/resources/css/productInsert.css">
	...
	<script>
		...
		function pdInsert(){
			...
			fm.action="<%=request.getContextPath() %>/admin/pdAllList.do";
			fm.method="post";
			fm.submit();
			return;	
		}	
	...
	<div class="bigBox">
		...
		<div class="myPageMenu">
			...
			<div class="myPageMenu2">
				...
				<div class="myPageMenu3">
					...
					<a href="<%=request.getContextPath() %>/admin/productInsert.do" class="red">상품 등록*</a>
				</div>
			</div>
			<div class="myPageMenu2">
		...
		<div class="pdInsertBox">
			<div class="pdInsertSmBox">
				<h3>상품 등록</h3>
				<br>
				<form id="frm" name="frm" action="<%=request.getContextPath() %>/admin/pdAllList.do" method="POST" enctype="multipart/form-data">
					<table>
						<tr>
