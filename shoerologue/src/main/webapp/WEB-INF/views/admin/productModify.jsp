...
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1, minimum-scale=1">
	...
	<script>
		...
		function modify(){
			...
			fm.action="<%=request.getContextPath() %>/admin/productModify.do";
			fm.method="post";
			fm.submit();
			return;	
		}	
	...
	<div class="bigBox">
		...
		<div class="pdInsertBox">
			<div class="pdInsertSmBox">
				<h3>상품 수정</h3>
				<br>
				<form id="frm" name="frm" action="<%=request.getContextPath() %>/admin/productModify.do?pidx=<%=pdvo.getPidx()%>" method="POST" enctype="multipart/form-data">
