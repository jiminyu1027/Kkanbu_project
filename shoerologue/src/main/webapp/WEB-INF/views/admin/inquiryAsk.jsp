...
<!-- body  -->
	...
	<div style=" float: left; width: 0%;">&nbsp;</div>
		...
		<form action="<%=request.getContextPath()%>/mypage/memberCounsel/inquiryAction.do" method="post" class="frm" id="frm" name="frm" enctype="multipart/form-data">
			<table class="ask-box">
				<colgroup>
					<col width="10%">
					<col width="90%">
		...
		<a href="<%=request.getContextPath()%>/mypage/memberCounsel/inquiry.do" class="cancel"><input type="button" value="문의 취소" class="cancel-button"></a>
	</div>	
<!-- 우측하단 TOP 이동 배너 -->
	<div class="empty-box"></div>
	<div class="empty-box"></div>
	    ...
	    <div class="row">
	      ...
	      <div class="col-4 col-sm-4 col-md-2">
	        ...
	        <ul class="nav flex-column">
	          <li class="nav-item mb-2"><a href="<%=request.getContextPath()%>/cs.do" class="nav-link p-0 text-muted">고객센터</a></li>
