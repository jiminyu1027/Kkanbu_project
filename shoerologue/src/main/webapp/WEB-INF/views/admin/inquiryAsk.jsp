	...
	<div class="container">
			<nav class="navbar navbar-expand-lg navbar-light topNav">
			      ...
			      <ul class="nav justify-content-end"> 
					  <li class="nav-item">
					    <a class="nav-link text-black-50 fw-bolder" href="/login.do">로그인</a>
					  </li>
					  <li class="nav-item">
					    <a class="nav-link text-black-50 fw-bolder" href="/member/join.do">회원가입</a>
					  </li>
					</ul>
				</nav>
			</div>
...
<!-- body  -->
	...
	<div class="body-box">
		...
		<div><span class="mainTitle">문의내용</span></div>
		<form action="/CustomerService/inquiry.do" method="post" class="frm" id="frm" name="frm">
			<table class="ask-box">
				<colgroup>
					<col width="10%">
					<col width="90%">
		...
		<a href="/CustomerService/inquiry.do" class="cancel"><input type="button" value="문의 취소" class="cancel-button"></a>
	</div>	
<!-- 우측하단 TOP 이동 배너 -->
	<div class="empty-box"></div>
	<div class="empty-box"></div>
