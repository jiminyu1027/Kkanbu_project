...
<!-- body  -->
	...
	<div class="body-box">
		...
		<div class="myPageMenu">
			...
			<div class="myPageMenu2">
				...
				<div class="myPageMenu3">
					...
					<a href="<%=request.getContextPath()%>/mypage/shopping/myReview.do" class="red">나의 리뷰*</a>
				</div><br>
			</div>
			<div class="myPageMenu2">
		...
		<!-- 좌측 마이페이지 메뉴 여기서 끝 -->
		<form action="<%=request.getContextPath()%>/mypage/shopping/myReviewAction.do" method="post" class="frm" id="frm" name="frm" enctype="multipart/form-data" onsubmit="return subFn()">
			...
			<table class="inquiry-box">
				...
				<tr>
					<td colspan="2">
						<center><h5>구매하신 제품은 어떠셨나요?</h5></center>
					</td>
				</tr>
				<tr class="trs-line">
				...
				<tr>
					<td>
						<input type="button" value="취소" class="cancelFn" onclick="location.href='<%=request.getContextPath()%>/mypage/shopping/myReview.do'">
					</td>
				</tr>
			</table>
		</form>
