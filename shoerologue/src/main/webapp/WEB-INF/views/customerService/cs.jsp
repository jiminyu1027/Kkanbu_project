...
<!-- body  -->
	...
	<div class="body-box">
		...
		<div class="filter-box">
			...
			<center><p><a href="<%=request.getContextPath()%>/customerService/cs.do" class="main">FAQ</a></p></center>
			<center><p><a href="<%=request.getContextPath()%>/customerService/notice.do" class="other">공지사항</a></p></center>
