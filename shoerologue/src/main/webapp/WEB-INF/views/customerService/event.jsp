...
<!-- body  -->
	...
	<form action="<%=request.getContextPath()%>/customerService/notice.do" method="post">
		...
		<table>
			...
			<tbody>
				...
				<tr>
					...
					<td colspan="3">
						<img src="<%=request.getContextPath()%><%=nvo.getnFile() %>" class="d-block w-100" style="width:100%; height:500px;">
					</td>
					<%}else{ %>
