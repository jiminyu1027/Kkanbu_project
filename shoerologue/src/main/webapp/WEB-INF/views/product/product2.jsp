...
<html>
	<head>
		...
		<!-- 상품 이미지 페이지 클릭시 검정 테두리-->
		<script>
			$(function(){
				$(".pdSmImgeBox a").click(function(){
					$(".pdSmImgeBox a img").css("border","1px solid black")
							...
							<div>
								<table>
									...
									<tr>
										<th>사이즈</th>
										<td>
											<button class="productSizeBtn">${product.pSize}</button>
											<button class="productSizeBtn">220</button>
											<button class="productSizeBtn">230</button>
											<button class="productSizeBtn">240</button>
											<button class="productSizeBtn">250</button>
										</td>
									</tr>
									<tr>
										<th></th>
										<td>	
											<button class="productSizeBtn">260</button>
											<button class="productSizeBtn">270</button>
											<button class="productSizeBtn">280</button>
											<button class="productSizeBtn">290</button>
											<button class="productSizeBtn">300</button>
											<button class="productSizeBtn">310</button>
										</td>
									</tr>
								</table>
							</div>
