...
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1, minimum-scale=1">
	...
	function selChange() {
		...
		location.href="<%=request.getContextPath() %>/category/gender/men.do?nowPage=${paging.nowPage}&cntPerPage="+sel;
	}
</script>
</head>
<body>
	...
	<div class="bigBox">
		...
		<div class="brandBox">
			<div class="totalPdSel">
				<div  class="totalPd">
					<span>총 <span class="redBold"><%=menlist.size()%></span>개의 상품이 있습니다.</span>
				</div>
				<div class="selection">
					<select class="">
			...
			<div class="brandPdBox">
				<div class="brandPdSmBox">
					<%
			    	 ...
			    	 %>
					<div class="brandPd">
						<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=menlist.get(i).getPidx()%>">
							<img src="<%=request.getContextPath() %>/resources/image/productdetail/<%=menlist.get(i).getpFile1()%>">
