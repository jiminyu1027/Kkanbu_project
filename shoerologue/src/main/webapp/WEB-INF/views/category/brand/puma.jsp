			...
			<div>
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=pumalist.get(8).getPidx()%>">
						<img src="/shoerologue/resources/<%=pumalist.get(8).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=pumalist.get(11).getPidx()%>">
						<img src="/shoerologue/resources/<%=pumalist.get(11).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=pumalist.get(6).getPidx()%>">
						<img src="/shoerologue/resources/<%=pumalist.get(6).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=pumalist.get(5).getPidx()%>">
						<img src="/shoerologue/resources/<%=pumalist.get(5).getpFile1()%>">
				...
				<div class="brandPdSmBox">
					...
					<div class="brandPd">
						<a href="/shoerologue/product/product.do?pidx=<%=pumalist.get(i).getPidx()%>">
							<img src="/shoerologue/resources/<%=pumalist.get(i).getpFile1()%>">
