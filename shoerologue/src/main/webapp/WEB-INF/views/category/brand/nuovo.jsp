...
<!-- body  -->
	...
	<div class="brandBanner">
		<img src="/shoerologue/resources/image/brandbanner/N/NUOVObanner.png">
	</div>
	<div class="bigBox">
		<div class="bestBox">
			...
			<div>
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=nuovolist.get(16).getPidx()%>">
						<img src="/shoerologue/resources/image/productdetail/<%=nuovolist.get(16).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=nuovolist.get(15).getPidx()%>">
						<img src="/shoerologue/resources/image/productdetail/<%=nuovolist.get(15).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=nuovolist.get(6).getPidx()%>">
						<img src="/shoerologue/resources/image/productdetail/<%=nuovolist.get(6).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=nuovolist.get(0).getPidx()%>">
						<img src="/shoerologue/resources/image/productdetail/<%=nuovolist.get(0).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=nuovolist.get(5).getPidx()%>">
						<img src="/shoerologue/resources/image/productdetail/<%=nuovolist.get(5).getpFile1()%>">
			...
			<!-- 브랜드별 상품 첫번째줄 -->
				<div class="brandPdSmBox">
					<%
			    	 ...
			    	 %>
					<div class="brandPd">
						<a href="/shoerologue/product/product.do?pidx=<%=nuovolist.get(i).getPidx()%>">
							<img src="/shoerologue/resources/image/productdetail/<%=nuovolist.get(i).getpFile1()%>">
