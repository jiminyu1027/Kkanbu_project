			...
			<div>
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=nuovolist.get(16).getPidx()%>">
						<img src="/shoerologue/resources/<%=nuovolist.get(16).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=nuovolist.get(15).getPidx()%>">
						<img src="/shoerologue/resources/<%=nuovolist.get(15).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=nuovolist.get(0).getPidx()%>">
						<img src="/shoerologue/resources/<%=nuovolist.get(0).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=nuovolist.get(5).getPidx()%>">
						<img src="/shoerologue/resources/<%=nuovolist.get(5).getpFile1()%>">
				...
				<div class="brandPdSmBox">
					...
					<div class="brandPd">
						<a href="/shoerologue/product/product.do?pidx=<%=nuovolist.get(i).getPidx()%>">
							<img src="/shoerologue/resources/<%=nuovolist.get(i).getpFile1()%>">
