			...
			<div>
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=raragolist.get(1).getPidx()%>">
						<img src="/shoerologue/resources/<%=raragolist.get(1).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=raragolist.get(2).getPidx()%>">
						<img src="/shoerologue/resources/<%=raragolist.get(2).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=raragolist.get(3).getPidx()%>">
						<img src="/shoerologue/resources/<%=raragolist.get(3).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=raragolist.get(5).getPidx()%>">
						<img src="/shoerologue/resources/<%=raragolist.get(5).getpFile1()%>">
				...
				<div class="brandPdSmBox">
					...
					<div class="brandPd">
						<a href="/shoerologue/product/product.do?pidx=<%=raragolist.get(i).getPidx()%>">
							<img src="/shoerologue/resources/<%=raragolist.get(i).getpFile1()%>">
