...
<!-- body  -->
	...
	<div class="brandBanner">
		<img src="/shoerologue/resources/image/brandbanner/R/RARAGObanner.png">
	</div>
	<div class="bigBox">
		<div class="bestBox">
			...
			<div>
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=raragolist.get(6).getPidx()%>">
						<img src="/shoerologue/resources/image/productdetail/<%=raragolist.get(6).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=raragolist.get(1).getPidx()%>">
						<img src="/shoerologue/resources/image/productdetail/<%=raragolist.get(1).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=raragolist.get(2).getPidx()%>">
						<img src="/shoerologue/resources/image/productdetail/<%=raragolist.get(2).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=raragolist.get(3).getPidx()%>">
						<img src="/shoerologue/resources/image/productdetail/<%=raragolist.get(3).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=raragolist.get(5).getPidx()%>">
						<img src="/shoerologue/resources/image/productdetail/<%=raragolist.get(5).getpFile1()%>">
