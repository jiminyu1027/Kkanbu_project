...
<%
	List<ProductVO> bearpawlist = (List<ProductVO>)request.getAttribute("bearpawlist");
...
<!-- body  -->
	...
	<div class="brandBanner">
		<img src="<%=request.getContextPath() %>/resources/image/brandbanner/B/BEARPAWbanner.png">
	</div>
	<div class="bigBox">
		<div class="bestBox">
			...
			<div>
				<div class="bestPd">
					...
					<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=bearpawlist.get(0).getPidx()%>">
						<img src="<%=request.getContextPath() %>/resources/<%=bearpawlist.get(0).getpFile1()%>">
						<div class="shoesBrand"><%=bearpawlist.get(0).getpBrandKr()%></div>
						<div class="shoesName"><%=bearpawlist.get(0).getpNameKr()%></div>
						<div class="shoesPriceBox">
							<span class="shoesPrice">
								<% if(bearpawlist.get(0).getpPrice().length() <6) {%>
									<%=bearpawlist.get(0).getpPrice().substring(bearpawlist.get(0).getpPrice().length()-5,bearpawlist.get(0).getpPrice().length()-3) %>,<%=bearpawlist.get(0).getpPrice().substring(bearpawlist.get(0).getpPrice().length()-3,bearpawlist.get(0).getpPrice().length()) %>
								<%}else{ %>
									<%=bearpawlist.get(0).getpPrice().substring(bearpawlist.get(0).getpPrice().length()-6,bearpawlist.get(0).getpPrice().length()-3) %>,<%=bearpawlist.get(0).getpPrice().substring(bearpawlist.get(0).getpPrice().length()-3,bearpawlist.get(0).getpPrice().length()) %>
								<% } %>
							</span>
				...
				<div class="bestPd">
					...
					<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=bearpawlist.get(3).getPidx()%>">
						<img src="<%=request.getContextPath() %>/resources/<%=bearpawlist.get(3).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=bearpawlist.get(2).getPidx()%>">
						<img src="<%=request.getContextPath() %>/resources/<%=bearpawlist.get(2).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=bearpawlist.get(4).getPidx()%>">
						<img src="<%=request.getContextPath() %>/resources/<%=bearpawlist.get(4).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=bearpawlist.get(1).getPidx()%>">
						<img src="<%=request.getContextPath() %>/resources/<%=bearpawlist.get(1).getpFile1()%>">
		...
		<div class="brandBox">
			...
			<!-- 브랜드별 상품 첫번째줄 -->
				<div class="brandPdSmBox">
					<%
					     if(bearpawlist.size() != 0){
					     for(int i=0; i<bearpawlist.size();i++) {	    
			    	 %>
					<div class="brandPd">
						<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=bearpawlist.get(i).getPidx()%>">
							<img src="<%=request.getContextPath() %>/resources/<%=bearpawlist.get(i).getpFile1()%>">
