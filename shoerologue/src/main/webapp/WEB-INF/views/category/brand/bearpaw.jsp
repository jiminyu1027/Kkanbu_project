...
<!-- body  -->
	...
	<div class="brandBanner">
		<img src="/shoerologue/resources/image/brandbanner/B/BEARPAWbanner.png">
	</div>
	<div class="bigBox">
		<div class="bestBox">
			...
			<div>
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=bearpawlist.get(5).getPidx()%>">
						<img src="/shoerologue/resources/<%=bearpawlist.get(5).getpFile1()%>">
						<div class="shoesBrand"><%=bearpawlist.get(5).getpBrandKr()%></div>
						<div class="shoesName"><%=bearpawlist.get(5).getpNameKr()%></div>
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=bearpawlist.get(3).getPidx()%>">
						<img src="/shoerologue/resources/<%=bearpawlist.get(3).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=bearpawlist.get(2).getPidx()%>">
						<img src="/shoerologue/resources/<%=bearpawlist.get(2).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=bearpawlist.get(4).getPidx()%>">
						<img src="/shoerologue/resources/<%=bearpawlist.get(4).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=bearpawlist.get(1).getPidx()%>">
						<img src="/shoerologue/resources/<%=bearpawlist.get(1).getpFile1()%>">
			...
			<!-- 브랜드별 상품 첫번째줄 -->
				<div class="brandPdSmBox">
					<%
			    	 ...
			    	 %>
					<div class="brandPd">
						<a href="/shoerologue/product/product.do?pidx=<%=bearpawlist.get(i).getPidx()%>">
							<img src="/shoerologue/resources/<%=bearpawlist.get(i).getpFile1()%>">
