...
<!-- body  -->
	...
	<div class="brandBanner">
		<!-- <img src="/shoerologue/resources/image/brandbanner/J/JORDANbanner.png">  -->
	</div>
	<div class="bigBox">
		<div class="bestBox">
			...
			<div>
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=jordanlist.get(0).getPidx()%>">
						<img src="/shoerologue/resources/<%=jordanlist.get(0).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=jordanlist.get(7).getPidx()%>">
						<img src="/shoerologue/resources/<%=jordanlist.get(7).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=jordanlist.get(4).getPidx()%>">
						<img src="/shoerologue/resources/<%=jordanlist.get(4).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=jordanlist.get(5).getPidx()%>">
						<img src="/shoerologue/resources/<%=jordanlist.get(5).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=jordanlist.get(1).getPidx()%>">
						<img src="/shoerologue/resources/<%=jordanlist.get(1).getpFile1()%>">
			...
			<!-- 브랜드별 상품 첫번째줄 -->
				<div class="brandPdSmBox">
					<%
			    	 ...
			    	 %>
					<div class="brandPd">
						<a href="/shoerologue/product/product.do?pidx=<%=jordanlist.get(i).getPidx()%>">
							<img src="/shoerologue/resources/<%=jordanlist.get(i).getpFile1()%>">
