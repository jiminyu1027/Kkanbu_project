...
<%
	List<ProductVO> jordanlist = (List<ProductVO>)request.getAttribute("jordanlist");
...
<!-- body  -->
	...
	<div class="bigBox">
		<div class="brandNameBox">
			<div class="brandName">JORDAN&nbsp;&nbsp;|&nbsp;&nbsp;조던</div>
		</div>
	</div>
	<div class="brandBanner">
		<!-- <img src="<%=request.getContextPath() %>/resources/image/brandbanner/J/JORDANbanner.png">  -->
	</div>
	<div class="bigBox">
		<div class="bestBox">
			...
			<div>
				<div class="bestPd">
					...
					<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=jordanlist.get(0).getPidx()%>">
						<img src="<%=request.getContextPath() %>/resources/<%=jordanlist.get(0).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=jordanlist.get(6).getPidx()%>">
						<img src="<%=request.getContextPath() %>/resources/<%=jordanlist.get(6).getpFile1()%>">
						<div class="shoesBrand"><%=jordanlist.get(6).getpBrandKr()%></div>
						<div class="shoesName"><%=jordanlist.get(6).getpNameKr()%></div>
						<div class="shoesPriceBox">
							<span class="shoesPrice">
								<% if(jordanlist.get(6).getpPrice().length() <6) {%>
									<%=jordanlist.get(6).getpPrice().substring(jordanlist.get(6).getpPrice().length()-5,jordanlist.get(6).getpPrice().length()-3) %>,<%=jordanlist.get(6).getpPrice().substring(jordanlist.get(6).getpPrice().length()-3,jordanlist.get(6).getpPrice().length()) %>
								<%}else{ %>
									<%=jordanlist.get(6).getpPrice().substring(jordanlist.get(6).getpPrice().length()-6,jordanlist.get(6).getpPrice().length()-3) %>,<%=jordanlist.get(6).getpPrice().substring(jordanlist.get(6).getpPrice().length()-3,jordanlist.get(6).getpPrice().length()) %>
								<% } %>
							</span>
							<span class="won">원</span>
						</div>
				...
				<div class="bestPd">
					...
					<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=jordanlist.get(4).getPidx()%>">
						<img src="<%=request.getContextPath() %>/resources/<%=jordanlist.get(4).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=jordanlist.get(5).getPidx()%>">
						<img src="<%=request.getContextPath() %>/resources/<%=jordanlist.get(5).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=jordanlist.get(1).getPidx()%>">
						<img src="<%=request.getContextPath() %>/resources/<%=jordanlist.get(1).getpFile1()%>">
		...
		<div class="brandBox">
			...
			<!-- 브랜드별 상품 첫번째줄 -->
				<div class="brandPdSmBox">
					<%
					     if(jordanlist.size() != 0){
					     for(int i=0; i<jordanlist.size();i++) {	    
			    	 %>
					<div class="brandPd">
						<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=jordanlist.get(i).getPidx()%>">
							<img src="<%=request.getContextPath() %>/resources/<%=jordanlist.get(i).getpFile1()%>">
