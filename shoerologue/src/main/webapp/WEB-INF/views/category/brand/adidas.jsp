...
<!-- body  -->
	...
	<div class="brandBanner">
		<img src="/shoerologue/resources/image/brandbanner/A/ADIDASbanner.png">
	</div>
	<div class="bigBox">
		<div class="bestBox">
			...
			<div>
				<div class="bestPd">
					...
					<a href="#">
						...
						<div class="shoesBrand">아디다스</div>
						<div class="shoesName">아디다스 에어 맥스 SC</div>
		...
		<div class="brandBox">
			<div class="totalPdSel">
				<div  class="totalPd">
					<span>총 <span class="redBold"><%=adidaslist.size()%></span>개의 상품이 있습니다.</span>
				</div>
				<div class="selection">
					<select class="">
