...
<%
	List<ProductVO> adidaslist = (List<ProductVO>)request.getAttribute("adidaslist");
...
<!-- body  -->
	...
	<div class="bigBox">
		<div class="brandNameBox">
			<div class="brandName">ADIDAS&nbsp;&nbsp;|&nbsp;&nbsp;아디다스</div>
		</div>
	</div>
	<div class="brandBanner">
		<img src="<%=request.getContextPath() %>/resources/image/brandbanner/A/ADIDASbanner.png">
	</div>
	<div class="bigBox">
		<%-- <div class="bestBox">
			...
			<div>
				<div class="bestPd">
					...
					<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=adidaslist.get(15).getPidx()%>">
						<img src="<%=request.getContextPath() %>/resources/<%=adidaslist.get(15).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=adidaslist.get(12).getPidx()%>">
						<img src="<%=request.getContextPath() %>/resources/<%=adidaslist.get(12).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=adidaslist.get(14).getPidx()%>">
						<img src="<%=request.getContextPath() %>/resources/<%=adidaslist.get(14).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=adidaslist.get(7).getPidx()%>">
						<img src="<%=request.getContextPath() %>/resources/<%=adidaslist.get(7).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=adidaslist.get(13).getPidx()%>">
						<img src="<%=request.getContextPath() %>/resources/<%=adidaslist.get(13).getpFile1()%>">
			...
			<div class="brandPdBox">
				<div class="brandPdSmBox">
					<%
					     ...
					     for(int i=0; i<adidaslist.size();i++) {	    
			    	 %>
					<div class="brandPd">
						<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=adidaslist.get(i).getPidx()%>">
							<img src="<%=request.getContextPath() %>/resources/<%=adidaslist.get(i).getpFile1()%>">
