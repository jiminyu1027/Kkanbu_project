...
<%
	List<ProductVO> hawkinslist = (List<ProductVO>)request.getAttribute("hawkinslist");
...
<!-- body  -->
	...
	<div class="bigBox">
		<div class="brandNameBox">
			<div class="brandName">HAWKINS&nbsp;&nbsp;|&nbsp;&nbsp;호킨스</div>
		</div>
	</div>
	<div class="brandBanner">
		<img src="<%=request.getContextPath() %>/resources/image/brandbanner/H/HAWKINSbanner.png">
	</div>
	<div class="bigBox">
		<%-- <div class="bestBox">
			...
			<div>
				<div class="bestPd">
					...
					<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=hawkinslist.get(10).getPidx()%>">
						<img src="<%=request.getContextPath() %>/resources/<%=hawkinslist.get(10).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=hawkinslist.get(0).getPidx()%>">
						<img src="<%=request.getContextPath() %>/resources/<%=hawkinslist.get(0).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=hawkinslist.get(20).getPidx()%>">
						<img src="<%=request.getContextPath() %>/resources/<%=hawkinslist.get(20).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=hawkinslist.get(12).getPidx()%>">
						<img src="<%=request.getContextPath() %>/resources/<%=hawkinslist.get(12).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=hawkinslist.get(5).getPidx()%>">
						<img src="<%=request.getContextPath() %>/resources/<%=hawkinslist.get(5).getpFile1()%>">
		...
		<div class="brandBox">
			...
			<!-- 브랜드별 상품 첫번째줄 -->
				<div class="brandPdSmBox">
					<%
					     if(hawkinslist.size() != 0){
					     for(int i=0; i<hawkinslist.size();i++) {	    
			    	 %>
					<div class="brandPd">
						<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=hawkinslist.get(i).getPidx()%>">
							<img src="<%=request.getContextPath() %>/resources/<%=hawkinslist.get(i).getpFile1()%>">
				...
				<div class="hr1"></div>
					<ul>
						<c:if test="${pageMaker.prev}">
							<li><a class="pm" href="<%=request.getContextPath() %>/category/brand/hawkins.do${pageMaker.makeQuery(pageMaker.startPage - 1)}">이전</a></li>
						</c:if> 
						<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
							<li><a class="pm" href="<%=request.getContextPath() %>/category/brand/hawkins.do${pageMaker.makeQuery(idx)}">${idx}</a></li>
						</c:forEach>
						<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
							<li><a class="pm" href="<%=request.getContextPath() %>/category/brand/hawkins.do${pageMaker.makeQuery(pageMaker.endPage + 1)}">다음</a></li>
						</c:if> 
					</ul>
				</div>
			</div>
