...
<!-- body  -->
	...
	<div class="brandBanner">
		<img src="/shoerologue/resources/image/brandbanner/H/HAWKINSbanner.png">
	</div>
	<div class="bigBox">
		<div class="bestBox">
			...
			<div>
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=hawkinslist.get(10).getPidx()%>">
						<img src="/shoerologue/resources/<%=hawkinslist.get(10).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=hawkinslist.get(0).getPidx()%>">
						<img src="/shoerologue/resources/<%=hawkinslist.get(0).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=hawkinslist.get(20).getPidx()%>">
						<img src="/shoerologue/resources/<%=hawkinslist.get(20).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=hawkinslist.get(12).getPidx()%>">
						<img src="/shoerologue/resources/<%=hawkinslist.get(12).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=hawkinslist.get(5).getPidx()%>">
						<img src="/shoerologue/resources/<%=hawkinslist.get(5).getpFile1()%>">
			...
			<!-- 브랜드별 상품 첫번째줄 -->
				<div class="brandPdSmBox">
					<%
			    	 ...
			    	 %>
					<div class="brandPd">
						<a href="/shoerologue/product/product.do?pidx=<%=hawkinslist.get(i).getPidx()%>">
							<img src="/shoerologue/resources/<%=hawkinslist.get(i).getpFile1()%>">
