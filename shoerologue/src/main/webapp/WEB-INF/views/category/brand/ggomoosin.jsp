...
<!-- body  -->
	...
	<div class="brandBanner">
		<img src="/shoerologue/resources/image/brandbanner/G/GGOMOOSINbanner.png">
	</div>
	<div class="bigBox">
		<div class="bestBox">
			...
			<div>
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=ggomoosinlist.get(10).getPidx()%>">
						<img src="/shoerologue/resources/image/productdetail/<%=ggomoosinlist.get(10).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=ggomoosinlist.get(6).getPidx()%>">
						<img src="/shoerologue/resources/image/productdetail/<%=ggomoosinlist.get(6).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=ggomoosinlist.get(9).getPidx()%>">
						<img src="/shoerologue/resources/image/productdetail/<%=ggomoosinlist.get(9).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=ggomoosinlist.get(2).getPidx()%>">
						<img src="/shoerologue/resources/image/productdetail/<%=ggomoosinlist.get(2).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=ggomoosinlist.get(0).getPidx()%>">
						<img src="/shoerologue/resources/image/productdetail/<%=ggomoosinlist.get(0).getpFile1()%>">
