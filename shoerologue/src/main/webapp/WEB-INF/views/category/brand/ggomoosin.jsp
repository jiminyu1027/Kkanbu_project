			...
			<div>
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=ggomoosinlist.get(10).getPidx()%>">
						<img src="/shoerologue/resources/<%=ggomoosinlist.get(10).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=ggomoosinlist.get(6).getPidx()%>">
						<img src="/shoerologue/resources/<%=ggomoosinlist.get(6).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=ggomoosinlist.get(9).getPidx()%>">
						<img src="/shoerologue/resources/<%=ggomoosinlist.get(9).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=ggomoosinlist.get(2).getPidx()%>">
						<img src="/shoerologue/resources/<%=ggomoosinlist.get(2).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=ggomoosinlist.get(0).getPidx()%>">
						<img src="/shoerologue/resources/<%=ggomoosinlist.get(0).getpFile1()%>">
				...
				<div class="brandPdSmBox">
					...
					<div class="brandPd">
						<a href="/shoerologue/product/product.do?pidx=<%=ggomoosinlist.get(i).getPidx()%>">
							<img src="/shoerologue/resources/<%=ggomoosinlist.get(i).getpFile1()%>">
