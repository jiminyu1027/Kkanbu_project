...
<!-- body  -->
	...
	<div class="bigBox">
		<div class="brandNameBox">
			<div class="brandName">REEBOK&nbsp;&nbsp;|&nbsp;&nbsp;리복</div>
		</div>
	</div>
	<div class="brandBanner">
		<img src="<%=request.getContextPath() %>/resources/image/brandbanner/R/REEBOKbanner.png">
	</div>
	<div class="bigBox">
		<div class="bestBox">
			...
			<div>
				<div class="bestPd">
					...
					<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=reeboklist.get(5).getPidx()%>">
						<img src="<%=request.getContextPath() %>/resources/<%=reeboklist.get(5).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=reeboklist.get(0).getPidx()%>">
						<img src="<%=request.getContextPath() %>/resources/<%=reeboklist.get(0).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=reeboklist.get(1).getPidx()%>">
						<img src="<%=request.getContextPath() %>/resources/<%=reeboklist.get(1).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=reeboklist.get(7).getPidx()%>">
						<img src="<%=request.getContextPath() %>/resources/<%=reeboklist.get(7).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=reeboklist.get(3).getPidx()%>">
						<img src="<%=request.getContextPath() %>/resources/<%=reeboklist.get(3).getpFile1()%>">
			...
			<!-- 브랜드별 상품 첫번째줄 -->
				<div class="brandPdSmBox">
					<%
			    	 ...
			    	 %>
					<div class="brandPd">
						<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=reeboklist.get(i).getPidx()%>">
							<img src="<%=request.getContextPath() %>/resources/<%=reeboklist.get(i).getpFile1()%>">
