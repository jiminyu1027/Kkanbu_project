...
<!-- body  -->
	...
	<div class="brandBanner">
		<img src="/shoerologue/resources/image/brandbanner/R/REEBOKbanner.png">
	</div>
	<div class="bigBox">
		<div class="bestBox">
			...
			<div>
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=reeboklist.get(5).getPidx()%>">
						<img src="/shoerologue/resources/<%=reeboklist.get(5).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=reeboklist.get(0).getPidx()%>">
						<img src="/shoerologue/resources/<%=reeboklist.get(0).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=reeboklist.get(1).getPidx()%>">
						<img src="/shoerologue/resources/<%=reeboklist.get(1).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=reeboklist.get(7).getPidx()%>">
						<img src="/shoerologue/resources/<%=reeboklist.get(7).getpFile1()%>">
				...
				<div class="bestPd">
					...
					<a href="/shoerologue/product/product.do?pidx=<%=reeboklist.get(3).getPidx()%>">
						<img src="/shoerologue/resources/<%=reeboklist.get(3).getpFile1()%>">
				...
				<div class="brandPdSmBox">
					...
					<div class="brandPd">
						<a href="/shoerologue/product/product.do?pidx=<%=reeboklist.get(i).getPidx()%>">
							<img src="/shoerologue/resources/<%=reeboklist.get(i).getpFile1()%>">
