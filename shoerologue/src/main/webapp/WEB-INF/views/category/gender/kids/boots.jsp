...
<%
	List<ProductVO> kidslistboots = (List<ProductVO>)request.getAttribute("kidslistboots");
		...
		<div class="shoesBox">
			...
			<div class="shoesList">
				<ul>
				    ...
				    <li><a href="<%=request.getContextPath() %>/category/gender/kids/boots.do" class="redBold2">부츠</a></li>
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="brandBox">
			...
			<div class="brandPdBox">
				<div class="brandPdSmBox">
					<%
					     if(kidslistboots.size() != 0){
					     for(int i=0; i<kidslistboots.size();i++) {
			    	 %>
					<div class="brandPd">
						<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=kidslistboots.get(i).getPidx()%>">
							<img src="<%=request.getContextPath() %>/resources/<%=kidslistboots.get(i).getpFile1()%>">
							<div class="shoesBrand" id="pBrandKr"><%=kidslistboots.get(i).getpBrandKr()%></div>
							<div class="shoesName" id="pNameKr"><%=kidslistboots.get(i).getpNameKr()%></div>
							<div class="shoesPriceBox">
								<span class="shoesPrice" id="pPrice">
									<span class="pPrice" id="pPrice" name="pPrice">
										<% if(kidslistboots.get(i).getpPrice().length() <6) {%>
											<%=kidslistboots.get(i).getpPrice().substring(kidslistboots.get(i).getpPrice().length()-5,kidslistboots.get(i).getpPrice().length()-3) %>,<%=kidslistboots.get(i).getpPrice().substring(kidslistboots.get(i).getpPrice().length()-3,kidslistboots.get(i).getpPrice().length()) %>
										<%}else{ %>
											<%=kidslistboots.get(i).getpPrice().substring(kidslistboots.get(i).getpPrice().length()-6,kidslistboots.get(i).getpPrice().length()-3) %>,<%=kidslistboots.get(i).getpPrice().substring(kidslistboots.get(i).getpPrice().length()-3,kidslistboots.get(i).getpPrice().length()) %>
										<% } %>
									</span>
								</span>
				...
				<div class="hr1"></div>
					<ul>
						<c:if test="${pageMaker.prev}">
							<li><a class="pm" href="<%=request.getContextPath() %>/category/gender/kids/boots.do${pageMaker.makeQuery(pageMaker.startPage - 1)}">이전</a></li>
						</c:if> 
						<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
							<li><a class="pm" href="<%=request.getContextPath() %>/category/gender/kids/boots.do${pageMaker.makeQuery(idx)}">${idx}</a></li>
						</c:forEach>
						<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
							<li><a class="pm" href="<%=request.getContextPath() %>/category/gender/kids/boots.do${pageMaker.makeQuery(pageMaker.endPage + 1)}">다음</a></li>
						</c:if> 
					</ul>
				</div>
			</div>
