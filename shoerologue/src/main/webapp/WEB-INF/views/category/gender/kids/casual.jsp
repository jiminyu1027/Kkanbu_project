		...
		<div class="shoesBox">
			...
			<div class="shoesList">
				<ul>
				    ...
				    <li><a href="/shoerologue/category/gender/kids/casual.do" class="redBold2">캐주얼</a></li>
			...
			<div class="brandPdBox">
				<div class="brandPdSmBox">
					<%
			    	 ...
			    	 %>
					<div class="brandPd">
						<a href="/shoerologue/product/product.do?pidx=<%=kidslistcasual.get(i).getPidx()%>">
							<img src="/shoerologue/resources/image/productdetail/<%=kidslistcasual.get(i).getpFile1()%>">
