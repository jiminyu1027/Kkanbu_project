...
<%
	List<ProductVO> kidslistsneakers = (List<ProductVO>)request.getAttribute("kidslistsneakers");
...
<!-- body  -->
	...
	<div class="bigBox">
		<div class="shoesBox">
			...
			<div class="shoesList">
				<ul>
					<li><a href="<%=request.getContextPath() %>/category/gender/kids/sneakers.do" class="redBold2">운동화</a></li>
			...
			<div class="brandPdBox">
				<div class="brandPdSmBox">
					<%
			    	 ...
			    	 %>
					<div class="brandPd">
						<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=kidslistsneakers.get(i).getPidx()%>">
							<img src="<%=request.getContextPath() %>/resources/<%=kidslistsneakers.get(i).getpFile1()%>">
							<div class="shoesBrand" id="pBrandKr"><%=kidslistsneakers.get(i).getpBrandKr()%></div>
							<div class="shoesName" id="pNameKr"><%=kidslistsneakers.get(i).getpNameKr()%></div>
							<div class="shoesPriceBox">
								<span class="shoesPrice" id="pPrice">
									<span class="pPrice" id="pPrice" name="pPrice">
										<% if(kidslistsneakers.get(i).getpPrice().length() <6) {%>
											<%=kidslistsneakers.get(i).getpPrice().substring(kidslistsneakers.get(i).getpPrice().length()-5,kidslistsneakers.get(i).getpPrice().length()-3) %>,<%=kidslistsneakers.get(i).getpPrice().substring(kidslistsneakers.get(i).getpPrice().length()-3,kidslistsneakers.get(i).getpPrice().length()) %>
										<%}else{ %>
											<%=kidslistsneakers.get(i).getpPrice().substring(kidslistsneakers.get(i).getpPrice().length()-6,kidslistsneakers.get(i).getpPrice().length()-3) %>,<%=kidslistsneakers.get(i).getpPrice().substring(kidslistsneakers.get(i).getpPrice().length()-3,kidslistsneakers.get(i).getpPrice().length()) %>
										<% } %>
									</span>
								</span>
				...
				<div class="hr1"></div>
					<ul>
						<c:if test="${pageMaker.prev}">
							<li><a class="pm" href="<%=request.getContextPath() %>/category/gender/kids/sneakers.do${pageMaker.makeQuery(pageMaker.startPage - 1)}">이전</a></li>
						</c:if> 
						<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
							<li><a class="pm" href="<%=request.getContextPath() %>/category/gender/kids/sneakers.do${pageMaker.makeQuery(idx)}">${idx}</a></li>
						</c:forEach>
						<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
							<li><a class="pm" href="<%=request.getContextPath() %>/category/gender/kids/sneakers.do${pageMaker.makeQuery(pageMaker.endPage + 1)}">다음</a></li>
						</c:if> 
					</ul>
				</div>
			</div>
