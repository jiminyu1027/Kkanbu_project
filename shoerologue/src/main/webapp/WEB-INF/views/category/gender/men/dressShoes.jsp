...
<%
	List<ProductVO> menlistdressshoes = (List<ProductVO>)request.getAttribute("menlistdressshoes");
...
<!-- body  -->
		...
		<div class="channel">
			<ul>
				<li><a href="<%=request.getContextPath() %>" style="color:#757575; font-size:1.1em">
					...
					HOME</a></li>&nbsp;&nbsp;>&nbsp;&nbsp;
				<li><a href="<%=request.getContextPath() %>/category/gender/men.do">MEN</a></li>&nbsp;&nbsp;>&nbsp;&nbsp;
				<li>구두</li>
			</ul>
		</div>
	</div>
	<div class="bigBox">
		<div class="shoesBox">
			...
			<div class="shoesList">
				<ul>
					<li><a href="<%=request.getContextPath() %>/category/gender/men/sneakers.do">운동화</a></li>
				 	<li><a href="<%=request.getContextPath() %>/category/gender/men/sports.do">스포츠</a></li>
				    <li><a href="<%=request.getContextPath() %>/category/gender/men/dressShoes.do" class="redBold2">구두</a></li>
				    <li><a href="<%=request.getContextPath() %>/category/gender/men/sandle.do">샌들</a></li>
				    <li><a href="<%=request.getContextPath() %>/category/gender/men/casual.do">캐주얼</a></li>
				    <li><a href="<%=request.getContextPath() %>/category/gender/men/boots.do">부츠</a></li>
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="brandBox">
			...
			<div class="brandPdBox">
				<div class="brandPdSmBox">
					<%
					     if(menlistdressshoes.size() != 0){
					     for(int i=0; i<menlistdressshoes.size();i++) {
			    	 %>
					<div class="brandPd">
						<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=menlistdressshoes.get(i).getPidx()%>">
							<img src="<%=request.getContextPath() %>/resources/<%=menlistdressshoes.get(i).getpFile1()%>">
							<div class="shoesBrand" id="pBrandKr"><%=menlistdressshoes.get(i).getpBrandKr()%></div>
							<div class="shoesName" id="pNameKr"><%=menlistdressshoes.get(i).getpNameKr()%></div>
							<div class="shoesPriceBox">
								<span class="shoesPrice" id="pPrice">
									<span class="pPrice" id="pPrice" name="pPrice">
										<% if(menlistdressshoes.get(i).getpPrice().length() <6) {%>
											<%=menlistdressshoes.get(i).getpPrice().substring(menlistdressshoes.get(i).getpPrice().length()-5,menlistdressshoes.get(i).getpPrice().length()-3) %>,<%=menlistdressshoes.get(i).getpPrice().substring(menlistdressshoes.get(i).getpPrice().length()-3,menlistdressshoes.get(i).getpPrice().length()) %>
										<%}else{ %>
											<%=menlistdressshoes.get(i).getpPrice().substring(menlistdressshoes.get(i).getpPrice().length()-6,menlistdressshoes.get(i).getpPrice().length()-3) %>,<%=menlistdressshoes.get(i).getpPrice().substring(menlistdressshoes.get(i).getpPrice().length()-3,menlistdressshoes.get(i).getpPrice().length()) %>
										<% } %>
									</span>
								</span>
				...
				<div class="hr1"></div>
					<ul>
						<c:if test="${pageMaker.prev}">
							<li><a class="pm" href="<%=request.getContextPath() %>/category/gender/men/dressshoes.do${pageMaker.makeQuery(pageMaker.startPage - 1)}">이전</a></li>
						</c:if> 
						<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
							<li><a class="pm" href="<%=request.getContextPath() %>/category/gender/men/dressshoes.do${pageMaker.makeQuery(idx)}">${idx}</a></li>
						</c:forEach>
						<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
							<li><a class="pm" href="<%=request.getContextPath() %>/category/gender/men/dressshoes.do${pageMaker.makeQuery(pageMaker.endPage + 1)}">다음</a></li>
						</c:if> 
					</ul>
				</div>
			</div>
