...
<%
	List<ProductVO> menlistsneakers = (List<ProductVO>)request.getAttribute("menlistsneakers");
...
<!-- body  -->
	...
	<div class="bigBox">
		<div class="shoesBox">
			...
			<div class="shoesList">
				<ul>
					<li><a href="<%=request.getContextPath() %>/category/gender/men/sneakers.do" class="redBold2">운동화</a></li>
				 	<li><a href="<%=request.getContextPath() %>/category/gender/men/sports.do">스포츠</a></li>
				    <li><a href="<%=request.getContextPath() %>/category/gender/men/dressShoes.do">구두</a></li>
		...
		<div class="brandBox">
			...
			<div class="brandPdBox">
				<div class="brandPdSmBox">
					<%
					     if(menlistsneakers.size() != 0){
					     for(int i=0; i<menlistsneakers.size();i++) {
			    	 %>
					<div class="brandPd">
						<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=menlistsneakers.get(i).getPidx()%>">
							<img src="<%=request.getContextPath() %>/resources/<%=menlistsneakers.get(i).getpFile1()%>">
							<div class="shoesBrand" id="pBrandKr"><%=menlistsneakers.get(i).getpBrandKr()%></div>
							<div class="shoesName" id="pNameKr"><%=menlistsneakers.get(i).getpNameKr()%></div>
							<div class="shoesPriceBox">
								<span class="shoesPrice" id="pPrice">
									<span class="pPrice" id="pPrice" name="pPrice">
										<% if(menlistsneakers.get(i).getpPrice().length() <6) {%>
											<%=menlistsneakers.get(i).getpPrice().substring(menlistsneakers.get(i).getpPrice().length()-5,menlistsneakers.get(i).getpPrice().length()-3) %>,<%=menlistsneakers.get(i).getpPrice().substring(menlistsneakers.get(i).getpPrice().length()-3,menlistsneakers.get(i).getpPrice().length()) %>
										<%}else{ %>
											<%=menlistsneakers.get(i).getpPrice().substring(menlistsneakers.get(i).getpPrice().length()-6,menlistsneakers.get(i).getpPrice().length()-3) %>,<%=menlistsneakers.get(i).getpPrice().substring(menlistsneakers.get(i).getpPrice().length()-3,menlistsneakers.get(i).getpPrice().length()) %>
										<% } %>
									</span>
								</span>
				...
				<div class="hr1"></div>
					<ul>
						<c:if test="${pageMaker.prev}">
							<li><a class="pm" href="<%=request.getContextPath() %>/category/gender/men/sneakers.do${pageMaker.makeQuery(pageMaker.startPage - 1)}">이전</a></li>
						</c:if> 
						<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
							<li><a class="pm" href="<%=request.getContextPath() %>/category/gender/men/sneakers.do${pageMaker.makeQuery(idx)}">${idx}</a></li>
						</c:forEach>
						<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
							<li><a class="pm" href="<%=request.getContextPath() %>/category/gender/men/sneakers.do${pageMaker.makeQuery(pageMaker.endPage + 1)}">다음</a></li>
						</c:if> 
					</ul>
				</div>
			</div>
