...
<%
	List<ProductVO> womenlistsneakers = (List<ProductVO>)request.getAttribute("womenlistsneakers");
...
<!-- body  -->
		...
		<div class="channel">
			<ul>
				<li><a href="<%=request.getContextPath() %>" style="color:#757575; font-size:1.1em">
					...
					HOME</a></li>&nbsp;&nbsp;>&nbsp;&nbsp;
				<li><a href="<%=request.getContextPath() %>/category/gender/women.do">WOMEN</a></li>&nbsp;&nbsp;>&nbsp;&nbsp;
				<li>운동화</li>
			</ul>
		</div>
	</div>
	<div class="bigBox">
		<div class="shoesBox">
			...
			<div class="shoesList">
				<ul>
					<li><a href="<%=request.getContextPath() %>/category/gender/women/sneakers.do" class="redBold2">운동화</a></li>
				 	<li><a href="<%=request.getContextPath() %>/category/gender/women/sports.do">스포츠</a></li>
				    <li><a href="<%=request.getContextPath() %>/category/gender/women/dressShoes.do">구두</a></li>
				    <li><a href="<%=request.getContextPath() %>/category/gender/women/sandle.do">샌들</a></li>
				    <li><a href="<%=request.getContextPath() %>/category/gender/women/casual.do">캐주얼</a></li>
				    <li><a href="<%=request.getContextPath() %>/category/gender/women/boots.do">부츠</a></li>
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="brandBox">
			...
			<div class="brandPdBox">
				<div class="brandPdSmBox">
					<%
					     if(womenlistsneakers.size() != 0){
					     for(int i=0; i<womenlistsneakers.size();i++) {
			    	 %>
					<div class="brandPd">
						<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=womenlistsneakers.get(i).getPidx()%>">
							<img src="<%=request.getContextPath() %>/resources/<%=womenlistsneakers.get(i).getpFile1()%>">
							<div class="shoesBrand" id="pBrandKr"><%=womenlistsneakers.get(i).getpBrandKr()%></div>
							<div class="shoesName" id="pNameKr"><%=womenlistsneakers.get(i).getpNameKr()%></div>
							<div class="shoesPriceBox">
								<span class="shoesPrice" id="pPrice">
									<span class="pPrice" id="pPrice" name="pPrice">
										<% if(womenlistsneakers.get(i).getpPrice().length() <6) {%>
											<%=womenlistsneakers.get(i).getpPrice().substring(womenlistsneakers.get(i).getpPrice().length()-5,womenlistsneakers.get(i).getpPrice().length()-3) %>,<%=womenlistsneakers.get(i).getpPrice().substring(womenlistsneakers.get(i).getpPrice().length()-3,womenlistsneakers.get(i).getpPrice().length()) %>
										<%}else{ %>
											<%=womenlistsneakers.get(i).getpPrice().substring(womenlistsneakers.get(i).getpPrice().length()-6,womenlistsneakers.get(i).getpPrice().length()-3) %>,<%=womenlistsneakers.get(i).getpPrice().substring(womenlistsneakers.get(i).getpPrice().length()-3,womenlistsneakers.get(i).getpPrice().length()) %>
										<% } %>
									</span>
								</span>
				...
				<div class="hr1"></div>
					<ul>
						<c:if test="${pageMaker.prev}">
							<li><a class="pm" href="<%=request.getContextPath() %>/category/gender/women/sneakers.do${pageMaker.makeQuery(pageMaker.startPage - 1)}">이전</a></li>
						</c:if> 
						<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
							<li><a class="pm" href="<%=request.getContextPath() %>/category/gender/women/sneakers.do${pageMaker.makeQuery(idx)}">${idx}</a></li>
						</c:forEach>
						<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
							<li><a class="pm" href="<%=request.getContextPath() %>/category/gender/women/sneakers.do${pageMaker.makeQuery(pageMaker.endPage + 1)}">다음</a></li>
						</c:if> 
					</ul>
				</div>
			</div>
