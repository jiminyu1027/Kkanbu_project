...
<!-- body  -->
		...
		<div class="channel">
			<ul>
				<li><a href="/shoerologue" style="color:#757575; font-size:1.1em">
					...
					HOME</a></li>&nbsp;&nbsp;>&nbsp;&nbsp;
				<li><a href="/shoerologue/category/gender/women.do">WOMEN</a></li>&nbsp;&nbsp;>&nbsp;&nbsp;
				<li>운동화</li>
			</ul>
		</div>
	</div>
	<div class="bigBox">
		<div class="shoesBox">
			...
			<div class="shoesList">
				<ul>
					<li><a href="/shoerologue/category/gender/women/sneakers.do" class="redBold2">운동화</a></li>
				 	<li><a href="/shoerologue/category/gender/women/sports.do">스포츠</a></li>
				    <li><a href="/shoerologue/category/gender/women/dressShoes.do">구두</a></li>
				    <li><a href="/shoerologue/category/gender/women/sandle.do">샌들</a></li>
				    <li><a href="/shoerologue/category/gender/women/casual.do">캐주얼</a></li>
				    <li><a href="/shoerologue/category/gender/women/boots.do">부츠</a></li>
				</ul>
			</div>
		</div>
	</div>
			...
			<div class="brandPdBox">
				<div class="brandPdSmBox">
					<%
			    	 ...
			    	 %>
					<div class="brandPd">
						<a href="/shoerologue/product/product.do?pidx=<%=womenlistsneakers.get(i).getPidx()%>">
							<img src="/shoerologue/resources/image/productdetail/<%=womenlistsneakers.get(i).getpFile1()%>">
				...
				<div class="hr1"></div>
					<ul>
						<c:if test="${pageMaker.prev}">
							<li><a class="pm" href="/shoerologue/category/gender/women/sneakers.do${pageMaker.makeQuery(pageMaker.startPage - 1)}">이전</a></li>
						</c:if> 
						<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
							<li><a class="pm" href="/shoerologue/category/gender/women/sneakers.do${pageMaker.makeQuery(idx)}">${idx}</a></li>
						</c:forEach>
						<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
							<li><a class="pm" href="/shoerologue/category/gender/women/sneakers.do${pageMaker.makeQuery(pageMaker.endPage + 1)}">다음</a></li>
						</c:if> 
					</ul>
				</div>
			</div>
