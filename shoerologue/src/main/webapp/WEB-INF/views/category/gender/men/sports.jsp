...
<%
	List<ProductVO> menlistsports = (List<ProductVO>)request.getAttribute("menlistsports");
			...
			<div class="shoesList">
				<ul>
					<li><a href="<%=request.getContextPath() %>/category/gender/men/sneakers.do">운동화</a></li>
				 	<li><a href="<%=request.getContextPath() %>/category/gender/men/sports.do" class="redBold2">스포츠</a></li>
		...
		<div class="brandBox">
			...
			<div class="brandPdBox">
				<div class="brandPdSmBox">
					<%
					     if(menlistsports.size() != 0){
					     for(int i=0; i<menlistsports.size();i++) {
			    	 %>
					<div class="brandPd">
						<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=menlistsports.get(i).getPidx()%>">
							<img src="<%=request.getContextPath() %>/resources/<%=menlistsports.get(i).getpFile1()%>">
							<div class="shoesBrand" id="pBrandKr"><%=menlistsports.get(i).getpBrandKr()%></div>
							<div class="shoesName" id="pNameKr"><%=menlistsports.get(i).getpNameKr()%></div>
							<div class="shoesPriceBox">
								<span class="shoesPrice" id="pPrice">
									<span class="pPrice" id="pPrice" name="pPrice">
										<% if(menlistsports.get(i).getpPrice().length() <6) {%>
											<%=menlistsports.get(i).getpPrice().substring(menlistsports.get(i).getpPrice().length()-5,menlistsports.get(i).getpPrice().length()-3) %>,<%=menlistsports.get(i).getpPrice().substring(menlistsports.get(i).getpPrice().length()-3,menlistsports.get(i).getpPrice().length()) %>
										<%}else{ %>
											<%=menlistsports.get(i).getpPrice().substring(menlistsports.get(i).getpPrice().length()-6,menlistsports.get(i).getpPrice().length()-3) %>,<%=menlistsports.get(i).getpPrice().substring(menlistsports.get(i).getpPrice().length()-3,menlistsports.get(i).getpPrice().length()) %>
										<% } %>
									</span>
								</span>
				...
				<div class="hr1"></div>
					<ul>
						<c:if test="${pageMaker.prev}">
							<li><a class="pm" href="<%=request.getContextPath() %>/category/gender/men/sports.do${pageMaker.makeQuery(pageMaker.startPage - 1)}">이전</a></li>
						</c:if> 
						<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
							<li><a class="pm" href="<%=request.getContextPath() %>/category/gender/men/sports.do${pageMaker.makeQuery(idx)}">${idx}</a></li>
						</c:forEach>
						<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
							<li><a class="pm" href="<%=request.getContextPath() %>/category/gender/men/sports.do${pageMaker.makeQuery(pageMaker.endPage + 1)}">다음</a></li>
						</c:if> 
					</ul>
				</div>
			</div>
