...
<%
	List<ProductVO> kidslistsandle = (List<ProductVO>)request.getAttribute("kidslistsandle");
		...
		<div class="shoesBox">
			...
			<div class="shoesList">
				<ul>
				    ...
				    <li><a href="<%=request.getContextPath() %>/category/gender/kids/sandle.do" class="redBold2">샌들</a></li>
		...
		<div class="brandBox">
			...
			<div class="brandPdBox">
				<div class="brandPdSmBox">
					<%
					     if(kidslistsandle.size() != 0){
					     for(int i=0; i<kidslistsandle.size(); i++) {  
			    	 %>
					<div class="brandPd">
						<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=kidslistsandle.get(i).getPidx()%>">
							<img src="<%=request.getContextPath() %>/resources/<%=kidslistsandle.get(i).getpFile1()%>">
							<div class="shoesBrand" id="pBrandKr"><%=kidslistsandle.get(i).getpBrandKr()%></div>
							<div class="shoesName" id="pNameKr"><%=kidslistsandle.get(i).getpNameKr()%></div>
							<div class="shoesPriceBox">
								<span class="shoesPrice" id="pPrice">
									<span class="pPrice" id="pPrice" name="pPrice">
										<% if(kidslistsandle.get(i).getpPrice().length() <6) {%>
											<%=kidslistsandle.get(i).getpPrice().substring(kidslistsandle.get(i).getpPrice().length()-5,kidslistsandle.get(i).getpPrice().length()-3) %>,<%=kidslistsandle.get(i).getpPrice().substring(kidslistsandle.get(i).getpPrice().length()-3,kidslistsandle.get(i).getpPrice().length()) %>
										<%}else{ %>
											<%=kidslistsandle.get(i).getpPrice().substring(kidslistsandle.get(i).getpPrice().length()-6,kidslistsandle.get(i).getpPrice().length()-3) %>,<%=kidslistsandle.get(i).getpPrice().substring(kidslistsandle.get(i).getpPrice().length()-3,kidslistsandle.get(i).getpPrice().length()) %>
										<% } %>
									</span>
								</span>
				...
				<div class="hr1"></div>
					<ul>
						<c:if test="${pageMaker.prev}">
							<li><a class="pm" href="<%=request.getContextPath() %>/category/gender/kids/sandle.do${pageMaker.makeQuery(pageMaker.startPage - 1)}">이전</a></li>
						</c:if> 
						<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
							<li><a class="pm" href="<%=request.getContextPath() %>/category/gender/kids/sandle.do${pageMaker.makeQuery(idx)}">${idx}</a></li>
						</c:forEach>
						<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
							<li><a class="pm" href="<%=request.getContextPath() %>/category/gender/kids/sandle.do${pageMaker.makeQuery(pageMaker.endPage + 1)}">다음</a></li>
						</c:if> 
					</ul>
				</div>
			</div>
