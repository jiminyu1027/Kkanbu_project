...
<%
	List<ProductVO> menlistcasual = (List<ProductVO>)request.getAttribute("menlistcasual");
		...
		<div class="shoesBox">
			...
			<div class="shoesList">
				<ul>
				    ...
				    <li><a href="<%=request.getContextPath() %>/category/gender/men/casual.do" class="redBold2">캐주얼</a></li>
		...
		<div class="brandBox">
			...
			<div class="brandPdBox">
				<div class="brandPdSmBox">
					<%
					     if(menlistcasual.size() != 0){
					     for(int i=0; i<menlistcasual.size();i++) {
			    	 %>
					<div class="brandPd">
						<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=menlistcasual.get(i).getPidx()%>">
							<img src="<%=request.getContextPath() %>/resources/<%=menlistcasual.get(i).getpFile1()%>">
							<div class="shoesBrand" id="pBrandKr"><%=menlistcasual.get(i).getpBrandKr()%></div>
							<div class="shoesName" id="pNameKr"><%=menlistcasual.get(i).getpNameKr()%></div>
							<div class="shoesPriceBox">
								<span class="shoesPrice" id="pPrice">
									<span class="pPrice" id="pPrice" name="pPrice">
										<% if(menlistcasual.get(i).getpPrice().length() <6) {%>
											<%=menlistcasual.get(i).getpPrice().substring(menlistcasual.get(i).getpPrice().length()-5,menlistcasual.get(i).getpPrice().length()-3) %>,<%=menlistcasual.get(i).getpPrice().substring(menlistcasual.get(i).getpPrice().length()-3,menlistcasual.get(i).getpPrice().length()) %>
										<%}else{ %>
											<%=menlistcasual.get(i).getpPrice().substring(menlistcasual.get(i).getpPrice().length()-6,menlistcasual.get(i).getpPrice().length()-3) %>,<%=menlistcasual.get(i).getpPrice().substring(menlistcasual.get(i).getpPrice().length()-3,menlistcasual.get(i).getpPrice().length()) %>
										<% } %>
									</span>
								</span>
				...
				<div class="hr1"></div>
					<ul>
						<c:if test="${pageMaker.prev}">
							<li><a class="pm" href="<%=request.getContextPath() %>/category/gender/men/casual.do${pageMaker.makeQuery(pageMaker.startPage - 1)}">이전</a></li>
						</c:if> 
						<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
							<li><a class="pm" href="<%=request.getContextPath() %>/category/gender/men/casual.do${pageMaker.makeQuery(idx)}">${idx}</a></li>
						</c:forEach>
						<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
							<li><a class="pm" href="<%=request.getContextPath() %>/category/gender/men/casual.do${pageMaker.makeQuery(pageMaker.endPage + 1)}">다음</a></li>
						</c:if> 
					</ul>
				</div>
			</div>
