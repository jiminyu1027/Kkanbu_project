...
<%
	List<ProductVO> womenlistsports = (List<ProductVO>)request.getAttribute("womenlistsports");
...
<!-- body  -->
	...
	<div class="bigBox">
		<div class="shoesBox">
			...
			<div class="shoesList">
				<ul>
					<li><a href="<%=request.getContextPath() %>/category/gender/women/sneakers.do">운동화</a></li>
				 	<li><a href="<%=request.getContextPath() %>/category/gender/women/sports.do" class="redBold2">스포츠</a></li>
		...
		<div class="brandBox">
			...
			<div class="brandPdBox">
				<div class="brandPdSmBox">
					<%
					     if(womenlistsports.size() != 0){
					     for(int i=0; i<womenlistsports.size();i++) {
			    	 %>
					<div class="brandPd">
						<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=womenlistsports.get(i).getPidx()%>">
							<img src="<%=request.getContextPath() %>/resources/<%=womenlistsports.get(i).getpFile1()%>">
							<div class="shoesBrand" id="pBrandKr"><%=womenlistsports.get(i).getpBrandKr()%></div>
							<div class="shoesName" id="pNameKr"><%=womenlistsports.get(i).getpNameKr()%></div>
							<div class="shoesPriceBox">
								<span class="shoesPrice" id="pPrice">
									<span class="pPrice" id="pPrice" name="pPrice">
										<% if(womenlistsports.get(i).getpPrice().length() <6) {%>
											<%=womenlistsports.get(i).getpPrice().substring(womenlistsports.get(i).getpPrice().length()-5,womenlistsports.get(i).getpPrice().length()-3) %>,<%=womenlistsports.get(i).getpPrice().substring(womenlistsports.get(i).getpPrice().length()-3,womenlistsports.get(i).getpPrice().length()) %>
										<%}else{ %>
											<%=womenlistsports.get(i).getpPrice().substring(womenlistsports.get(i).getpPrice().length()-6,womenlistsports.get(i).getpPrice().length()-3) %>,<%=womenlistsports.get(i).getpPrice().substring(womenlistsports.get(i).getpPrice().length()-3,womenlistsports.get(i).getpPrice().length()) %>
										<% } %>
									</span>
								</span>
				...
				<div class="hr1"></div>
					<ul>
						<c:if test="${pageMaker.prev}">
							<li><a class="pm" href="<%=request.getContextPath() %>/category/gender/women/sports.do${pageMaker.makeQuery(pageMaker.startPage - 1)}">이전</a></li>
						</c:if> 
						<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
							<li><a class="pm" href="<%=request.getContextPath() %>/category/gender/women/sports.do${pageMaker.makeQuery(idx)}">${idx}</a></li>
						</c:forEach>
						<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
							<li><a class="pm" href="<%=request.getContextPath() %>/category/gender/women/sports.do${pageMaker.makeQuery(pageMaker.endPage + 1)}">다음</a></li>
						</c:if> 
					</ul>
				</div>
			</div>
