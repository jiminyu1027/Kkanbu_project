...
<%
	List<ProductVO> menlistboots = (List<ProductVO>)request.getAttribute("menlistboots");
		...
		<div class="shoesBox">
			...
			<div class="shoesList">
				<ul>
				    ...
				    <li><a href="<%=request.getContextPath() %>/category/gender/men/boots.do" class="redBold2">부츠</a></li>
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="brandBox">
			...
			<div class="brandPdBox">
				<div class="brandPdSmBox">
					<%
					     if(menlistboots.size() != 0){
					     for(int i=0; i<menlistboots.size();i++) {
			    	 %>
					<div class="brandPd">
						<a href="<%=request.getContextPath() %>/product/product.do?pidx=<%=menlistboots.get(i).getPidx()%>">
							<img src="<%=request.getContextPath() %>/resources/<%=menlistboots.get(i).getpFile1()%>">
							<div class="shoesBrand" id="pBrandKr"><%=menlistboots.get(i).getpBrandKr()%></div>
							<div class="shoesName" id="pNameKr"><%=menlistboots.get(i).getpNameKr()%></div>
							<div class="shoesPriceBox">
								<span class="shoesPrice" id="pPrice">
									<span class="pPrice" id="pPrice" name="pPrice">
										<% if(menlistboots.get(i).getpPrice().length() <6) {%>
											<%=menlistboots.get(i).getpPrice().substring(menlistboots.get(i).getpPrice().length()-5,menlistboots.get(i).getpPrice().length()-3) %>,<%=menlistboots.get(i).getpPrice().substring(menlistboots.get(i).getpPrice().length()-3,menlistboots.get(i).getpPrice().length()) %>
										<%}else{ %>
											<%=menlistboots.get(i).getpPrice().substring(menlistboots.get(i).getpPrice().length()-6,menlistboots.get(i).getpPrice().length()-3) %>,<%=menlistboots.get(i).getpPrice().substring(menlistboots.get(i).getpPrice().length()-3,menlistboots.get(i).getpPrice().length()) %>
										<% } %>
									</span>
								</span>
				...
				<div class="hr1"></div>
					<ul>
						<c:if test="${pageMaker.prev}">
							<li><a class="pm" href="<%=request.getContextPath() %>/category/gender/men/boots.do${pageMaker.makeQuery(pageMaker.startPage - 1)}">이전</a></li>
						</c:if> 
						<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
							<li><a class="pm" href="<%=request.getContextPath() %>/category/gender/men/boots.do${pageMaker.makeQuery(idx)}">${idx}</a></li>
						</c:forEach>
						<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
							<li><a class="pm" href="<%=request.getContextPath() %>/category/gender/men/boots.do${pageMaker.makeQuery(pageMaker.endPage + 1)}">다음</a></li>
						</c:if> 
					</ul>
				</div>
			</div>
