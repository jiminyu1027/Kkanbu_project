...
public class SampleController {
	...
	public String list(Locale locale, Model model) throws Exception {
		//springtest 테이블의 모든 데이터 목록 가져와 화면으로 전달하기
	...
	public String modify(Locale locale, Model model, SampleVO vo) throws Exception{
		System.out.println("vo="+vo.getSidx());
	...
	public String del(Locale locale, Model model, int sidx) throws Exception{
		
		sampleService.del(sidx);
