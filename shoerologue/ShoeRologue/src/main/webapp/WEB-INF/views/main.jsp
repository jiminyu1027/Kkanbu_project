...
<html>
	<head>
		...
		<link href="<c:url value="/resources/css/headerFooter.css"/>" rel='stylesheet' />
		 ...
		 <div class="col-10 col-sm-8 col-md-6 col-lg-5">
			 <ul class="nav navMenu">
				...
				<li class="nav-item dropdown">
				    <a class="nav-link fw-bolder dropdown-toggle text-white" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">MEN</a>
				...
				<li class="nav-item dropdown">
				    <a class="nav-link fw-bolder dropdown-toggle text-white" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">WOMEN</a>
				    <ul class="dropdown-menu bg-black dropDownMenu mt-2">
	...
	<div class="jumping"></div>
		<img src="resources/image/005.png" style="width:100%;" class="img-fluid" alt="이젠카드 결제시 20% 할인 이벤트">
	<div class="jumping"></div>
	...
	<div class="jumping"></div>
	<!-- 3번째 배너 -->
	<img src="resources/image/banner3.png" style="width:100%;" class="img-fluid" alt="크리스마스 선물 이벤트">
	<!-- 공백 -->
	<div class="jumping"></div>
